...
import { Home, CheckCircle2, ArrowLeft, Save } from "lucide-react";
...
export default function EditRoomPage() {
  ...
  async function onConfirm() {
    ...
    try {
      ...
      const msg = e instanceof Error ? e.message : "Gagal memperbarui ruangan";
      setError(msg);
    }
  }
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-in fade-in duration-700">
      <PageHeader
        title="Edit Ruangan"
        description="Perbarui informasi ruangan toko Anda."
        actions={
          <Link href="/rooms">
        ...
        <CardHeader className="bg-slate-50/50 border-b border-slate-100/50 py-6 px-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription className="text-xs font-medium text-slate-400">Update nama dan status ruangan</CardDescription>
            </div>
          </div>
        </CardHeader>
